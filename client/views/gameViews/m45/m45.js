(function(){
  ...
  .controller('M45Ctrl', ['$scope', '$location', '$routeParams', 'Game', function($scope, $location, $routeParams, Game){
    ...
    $scope.m45Choice = function(choice){
      switch(choice){
        case 'one':
          $scope.passMessage = 'Mission Update: As a starship captain you have read the Odyssey by Homer and know all about what happened to Odysseus when he encountered the Sirens.  You fear something similar may be happening here so you drive your ship at maximum warp.';
        ...
        case 'two':
          $scope.passMessage = 'Mission Update: You stop to study the area and get stuck.  Some time later another ship travels by and sees you. It gets you unstuck and you find that you have been stuck for 100 years but none of your crew has aged or remembers what they have been doing for the last 100 years.  You continue on your journey.';
        ...
        case 'three':
          $scope.passMessage = 'Mission Update: You can\'t reist the beautiful voices and decide to follow them.  They lead you to the largest star which then consumes you.';
